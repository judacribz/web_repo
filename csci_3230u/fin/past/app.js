...
var PollResult = mongoose.model('pollResults', pollResultSchema);
...
app.listen(app.get('port'), function () {
    console.log('Node/Express listening on  http://localhost:' + this.address().port);
